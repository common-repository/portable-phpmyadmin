...
Tags: phpmyadmin, mysql, database, query, sql
...
**Note 1:** Portable phpMyAdmin has removed all insecure functionality. You should update your plugin as soon as possible to avoid any security risks!

Check out our [Portable phpMyAdmin TODO list](https://getbutterfly.com/demos/portable-phpmyadmin/ "Portable phpMyAdmin TODO list") for the upcoming release.

Portable phpMyAdmin allows a user to access the phpMyAdmin section straight from the Dashboard.

**Note 3:** This plugin should only be used for development purposes or by experienced users. If more users have access to the administration section, you should consider using the plugin *only when necessary*.

== Installation ==

Upload the Portable phpMyAdmin plugin to your blog, activate it, then go to Settings -> Portable phpMyAdmin to use it.

== Changelog ==

= 1.5.0 =
* UPDATE: Rerelease
* UPDATE: Updated WordPress and PHP compatibility
* SECURITY: Removed all phpMyAdmin functionality
* FEATURE: Added MySQL table editing
